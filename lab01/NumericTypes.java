...
public class NumericTypes {
   ...
   public static void main(String[] args) {
      ...
      // Scanner ninthKeyboardInput = new Scanner(System.in);
      // System.out.println("Now, simply enter the integer" +
      //                    " number, 2147483647, four times:");
      // intNumber = ninthKeyboardInput.nextInt();
      // // byteNumber = ninthKeyboardInput.nextByte();
      // // shortNumber = ninthKeyboardInput.nextShort();
      // longNumber = ninthKeyboardInput.nextLong();
      // floatNumber = ninthKeyboardInput.nextFloat();
      // doubleNumber = ninthKeyboardInput.nextDouble();
